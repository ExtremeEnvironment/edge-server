...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "EdgeServer@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "EdgeServer API";

        private String description = "EdgeServer API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "EdgeServer";
